...
show_info() {
    echo ""
    echo "NixOS Surface Slim - Minimal USB Recovery"
    echo "=========================================="
    echo ""
    echo "Features:"
    echo "  - Surface Pro hardware support (linux-surface)"
    echo "  - SDDM + Openbox minimal GUI"
    echo "  - Fish shell with CLI tools"
    echo "  - Node.js for Claude Code"
    echo "  - LUKS/btrfs tools for recovery"
    echo ""
    echo "Credentials:"
    echo "  User: diego"
    ...
    echo "  ./build.sh raw   - Build raw disk image"
